...
def main():
    ...
    pdf_directory = os.path.join(os.path.dirname(__file__), '../B Fiches techniques traitees')
    output_directory = os.path.join(os.path.dirname(__file__), '../C image extraites')
